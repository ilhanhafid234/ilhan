        ...
        <?php
			...
			if (!empty($wedding_event_management_embeds)) {
			    ...
			    foreach ($wedding_event_management_embeds as $wedding_event_management_embed) {
			        ...
			        if (strpos($wedding_event_management_embed, 'video') !== false || strpos($wedding_event_management_embed, 'youtube') !== false || strpos($wedding_event_management_embed, 'vimeo') !== false || strpos($wedding_event_management_embed, 'dailymotion') !== false || strpos($wedding_event_management_embed, 'vine') !== false || strpos($wedding_event_management_embed, 'wordPress.tv') !== false || strpos($wedding_event_management_embed, 'hulu') !== false) {
			            ?>

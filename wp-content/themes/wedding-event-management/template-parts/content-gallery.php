...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="mag-post-single">
        <?php
		    ...
		    $wedding_event_management_post_id = get_the_ID(); // Add this line to get the post ID
		    $wedding_event_management__gallery_shortcode = get_post_gallery();

		    if (!empty($wedding_event_management__gallery_shortcode)) {
		        // Display the gallery
		        echo '<div class="embedded-gallery">' . do_shortcode($wedding_event_management__gallery_shortcode) . '</div>';
		    }
		?>

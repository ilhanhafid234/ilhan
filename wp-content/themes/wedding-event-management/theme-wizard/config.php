...
$config['page_slug'] 	= 'wedding-event-management';
...
$config['steps'] = array(
	'intro' => array(
		...
		'title'			=> __( 'Welcome to ', 'wedding-event-management' ) . $theme_title, // Section title
		'icon'			=> 'dashboard', // Uses Dashicons
		'button_text'	=> __( 'Start Now', 'wedding-event-management' ), // Button text
